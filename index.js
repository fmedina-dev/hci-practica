...
/** Esta funcion se llama cuando la persona hace click en la fecha 
    derecha del carousel para navegar a la derecha */
function clickRight() {
...
/** Esta funcion se llama cuando la persona hace click en la
    fecha izquierda del carousel para navegar a la izquierda */
function clickLeft() {
  const currentLeft = parseInt(
    getComputedStyle(document.querySelector(".project-container")).left,
    10
...
/** Esta funcion se llama cuando la persona hace click
    en el boton de enviar del formulario de contacto */
...
/** Esta funcion se llama cuando la persona hace click
    en cualquier porjecto del carousel */
...
function closeModal(e) {
  /* Si el click occurio dentro del las imagenes del
     carousel o dentro del modal, no se cierra el modal */
  if (
